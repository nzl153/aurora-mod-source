...
/// <summary>
/// 散热令牌 / Vent Heat Token —— #25 微调二选一界面的<b>只读候选卡</b>（“散 1 热”一侧）。
...
public class AuroraVentHeatToken()
    : CustomCardModel(0, CardType.Skill, CardRarity.Token, TargetType.Self, showInCardLibrary: false)
{
    private const string ArtPath = "res://Aurora/Images/Cards/vent_heat_token.png";
